...
for(i=0;i<sampleData.length;i++)
  {
    newArray.push(sampleData[i].spend);
  }
  
console.log('This is the array for the spending amounts: ');
console.log(newArray);

var sum = newArray.reduce(add, 0);

function add(a, b) {
    return a + b;
}

console.log('This is the sum of all elements in newArray: ' + sum); // 6